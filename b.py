...
input_data['mgf2'] = st.sidebar.number_input("Spending on Souvenirs (mgf2)", min_value=0)
input_data['mgf3'] = st.sidebar.number_input("Spending on Entertainment (mgf3)", min_value=0)
input_data['mgf4'] = st.sidebar.number_input("Spending on Transportation (mgf4)", min_value=0)
input_data['mf1'] = st.sidebar.number_input("Income (mf1)", min_value=0)
...
# Footer
st.sidebar.text("Contact: your@email.com")
st.sidebar.text("Credits: Data provided by XYZ Corp")
